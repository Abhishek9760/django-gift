...
function loadAssets() {
    manifest = [
        {src: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/1524180/BAM.mp3", id: "bam"},
        {src: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/1524180/newyears.mp3", id: "newyears"},
    ];
...
function loadComplete() {
    ...
    for (var i = 0; i < l; i++) {
        ...
        createjs.Tween.get(bmp, {loop: -1, bounce: true}).to({
            scaleX: 0,
            scaleY: 0
        }, Math.random() * 500).wait(Math.random() * 500 | 0).to({scaleX: 1, scaleY: 1}, Math.random() * 500);
